<?php include('header.php');
  $setting = mysqli_fetch_array(mysqli_query($conn,"select * from `category1` where `id`='".$_GET['edit']."'"));
...
$name=mysqli_real_escape_string($conn, $name);
 ...
 $dsgf = mysqli_query($conn,"UPDATE `category1` SET `name`='$name' where `id`='".$_GET['edit']."'");
