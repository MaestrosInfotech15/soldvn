...
$category2_id=$_GET['cate2_id'];
$name=mysqli_real_escape_string($conn, $name);

 $dsgf = mysqli_query($conn,"INSERT INTO `category3`(`category2_id`,`name`)VALUES('$category2_id','$name')");

  if($dsgf){

$message="<span style='color:green'>Successfully</span>";
  echo "<script>window.location='category3.php?cate2_id=".$_GET['cate2_id']."?msg=add new text..'</script>";
                     ...
                     <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Category3</div>
                            </div>
