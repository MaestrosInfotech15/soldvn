...
if(isset($_GET['delete'])){
	mysqli_query($conn,"DELETE FROM `category1` WHERE `id`='".$_GET['delete']."'");
	echo "<script> window.location='category1.php?msg=Delete Sucessful';</script>";
   ...
   <div class="row-fluid">
          ...
          <div class="block">
              ...
              <div class="navbar navbar-inner block-header">
                       ...
                       <div class="muted pull-left">Show Category</div>
...
?>
              <!-- block -->
                        <div class="block">
                            <div class="navbar navbar-inner block-header ">
                                <div class="muted pull-left">Add Category1</div>
                        ...
                        <!-- /block -->
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                      ...
                                      <?php 
									  $n='1';
                                      $setting = mysqli_query($conn,"select * from category1");
						                ...
						                <tr>
						                 <td><?php echo $n++;?></td>
                                          ...
                                          <td><?php echo $service['name'];?></td>
                                                            <td><a href="category2.php?cate_id=<?php echo $service['id'];?>"><button class="btn btn-primary">View</button></a></td>                                                             
                                   <td><a onclick="return confirm('Are You Sure')" href="?delete=<?php echo $service['id'];?>"><button class="btn btn-danger">Delete</button></a>
                                  <a href="edit_category1.php?edit=<?php echo $service['id'];?>"><button class="btn btn-primary">Edit</button></a></td>
						                </tr>
                                       <?php }?>
